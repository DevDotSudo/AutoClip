  ...
  return <>
    ...
    <section className="section" id="workflow"><div className="container">
      ...
      <div className="steps-grid">{[
        ["01","Import","Upload a permitted video file directly to private R2 storage."],
